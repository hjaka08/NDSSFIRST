...
\begin{figure}[!hbp]
  ...
  \caption{PLI - Time Grapgh for one of 10 videos showing that greatly identical slopes between three runs, PLI - Time Grapgh of others is publicly available on our github repository~\cite{github}.}
  \label{fig:attacker-pipeline}
\end{figure}
